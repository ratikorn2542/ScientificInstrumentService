...
public class ViewChangeFormManager {

	public List<ChangeForm> getChangeRequestForm() {

		ConnectionDB condb = new ConnectionDB();
		Connection con = condb.getConection();
		Statement stmt = null;

		List<ChangeForm> listChangeForm = new Vector<>();
		try {
