...
public class ViewUsageScheduleManager {

	public FlatFeeForm getUsageschedule(String key) {
		...
		try {
			...
			while (rs.next()) {
				...
				form.setListSchedule(listSchedule);
	...
	public List<Schedule> getlistschedule(String key) {
		...
		try {
			...
			stmt = con.createStatement();
			String sql = " SELECT sd.schedule_ID,sd.startDateTime,sd.endDateTime ,sd.time,sd.maintenancefee,sd.additionalcost"
					+ " ,s.sciInstruments_ID,s.sciInstruments_Name,s.status,s.detail,s.priceType_A,s.priceType_B,s.priceType_C,s.priceType_D,s.priceFlatFee "
					+ " ,st.sciInstrumentsType_ID,st.sciInstrumentsType_Name "
			...
			while (rs.next()) {
				...
				String sf_staffid = rs.getString(18);
				String sf_prefix = rs.getString(19);
				String sf_firstname = rs.getString(20);
				String sf_lastname = rs.getString(21);
				String sf_email = rs.getString(22);
				String sf_phonenumber = rs.getString(23);
